 ...
 * **配置**
 *
 * - `['name', 'array', 'on' => 'scenario', 'message' => '%s 不能这么写哦']`
 * - `['name', 'array', 'except' => 'scenario', 'message' => '%s 不能这么写哦']`
 *
 * **配置参数**
 *
...
class AlphaNumericRule extends AbstractRule
{
    ...
    {
        return ['alpha', 'numeric', 'alphanumeric'];
    }
    ...
    public function validate(array $attributes, string $name, array $parameters = []): bool
    {
        ...
        $this->addError($name, $parameters, '%s 必须为字母或字符串');
