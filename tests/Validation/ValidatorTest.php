...
class ValidatorTest extends \PHPUnit\Framework\TestCase
{
     ...
     */
    public function testTrue(array $attributes, array $rule)
    {
        ...
        $this->assertEquals('', $this->validator->getLastError());
    }

    public function trueRulesProvider()
    {
        return [
            [
                [ 'name' => 'string' ],
    ...
    public function falseRulesProvider()
    {
        return [
            [
                [ ],
